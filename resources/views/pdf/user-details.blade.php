...
<body>
    <div class="container w-full space-y-6">
            ...
            <div class="card-body">
                <table class="table-auto w-full text-left border-collapse border border-gray-200">
                    <tbody>
                        ...
                        <tr class="border border-gray-200">
                            <th class="px-4 py-2 font-medium">Details of Experience</th>
                            <td class="px-4 py-2">{{ $formApplication->details_of_experience ?? '-' }}</td>
                        </tr>
                        <tr class="border border-gray-200">
                            <th class="px-4 py-2 font-medium">Expectations</th>
                            <td class="px-4 py-2">{{ $formApplication->expectations ?? '-' }}</td>
                        </tr>
                        <tr class="border border-gray-200">
                            <th class="px-4 py-2 font-medium">Photo</th>
                            <td class="px-4 py-2">
                                @if ($formApplication->hasMedia('profile_photo'))
                                    <div class="mb-3">
        ...
        <div style="page-break-before: always; page-break-after: always;">
            <div class="px-4 py-2 font-medium">Voucher</div>
            <div class="px-4 py-2" style="text-align: center;">

                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form class="grid grid-cols-12 gap-3 needs-validation custom-input"
                                ...
                                <div class="col-span-12 md:col-span-12 position-relative">
                                    <label for="details_of_experience" class="form-label">Details of Experience</label>
                                    <textarea id="details_of_experience" name="details_of_experience" rows="4" required
                                        class="form-control @error('details_of_experience') is-invalid @enderror">{{ old('details_of_experience') ?? ($profile->details_of_experience ?? '') }}</textarea>
                                    @error('details_of_experience')
                                        <div class="text-red-600 text-sm">{{ $message }}</div>
                                    @enderror
                                </div>
                                ...
                                <div class="col-span-12 md:col-span-12 position-relative">
                                    ...
                                    <textarea id="expectations" name="expectations" rows="4" required
                                        class="form-control @error('expectations') is-invalid @enderror">{{ old('expectations') ?? ($profile->expectations ?? '') }}</textarea>
                                    @error('expectations')
                                        <div class="text-red-600 text-sm">{{ $message }}</div>
                                    @enderror
                                </div>
                                ...
                                <div class="col-span-12 md:col-span-12 position-relative">
                                    ...
                                    @if (isset($formApplication) && $formApplication->hasMedia('voucher'))
                                        <div class="mb-3">
                                            <img src="{{ $formApplication->getFirstMediaUrl('voucher') }}" alt="Voucher"

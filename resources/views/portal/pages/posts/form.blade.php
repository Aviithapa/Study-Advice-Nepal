...
<form class="grid grid-cols-12 gap-3"
    action="{{ $isEdit ? route('posts.update', ['post' => $data->id]) : route('posts.store') }}" method="POST"
    ...
    <div class="col-span-6 md:col-span-12">
        ...
        @if ($isEdit && $data->hasMedia('post_image'))
            <div class="mt-2">
                <img src="{{ $data->getFirstMediaUrl('post_image') }}" alt="data Image"

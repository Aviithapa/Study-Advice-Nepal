...
<form class="grid grid-cols-12 gap-3"
    action="{{ $isEdit ? route('destinations.update', ['destination' => $data->id]) : route('destinations.store') }}"
    ...
    <div class="col-span-6 md:col-span-12">
        ...
        @if ($isEdit && $data->hasMedia('destination_image'))
            <div class="mt-2">
                <img src="{{ $data->getFirstMediaUrl('destination_image') }}" alt="data Image"

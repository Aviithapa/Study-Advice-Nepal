...
<form class="grid grid-cols-12 gap-3"
    action="{{ $isEdit ? route('services.update', ['service' => $data->id]) : route('services.store') }}" method="POST"
    ...
    <div class="col-span-6 md:col-span-12">
        ...
        @if ($isEdit && $data->hasMedia('service_image'))
            <div class="mt-2">
                <img src="{{ $data->getFirstMediaUrl('service_image') }}" alt="data Image"

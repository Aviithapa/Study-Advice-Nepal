...
<form class="grid grid-cols-12 gap-3"
    action="{{ $isEdit ? route('testimonials.update', ['testimonial' => $data->id]) : route('testimonials.store') }}"
    ...
    <div class="col-span-6 md:col-span-12">
        ...
        @if ($isEdit && $data->hasMedia('testimonial_image'))
            <div class="mt-2">
                <img src="{{ $data->getFirstMediaUrl('testimonial_image') }}" alt="data Image"

...
<form class="grid grid-cols-12 gap-3"
    action="{{ $isEdit ? route('features.update', ['feature' => $data->id]) : route('features.store') }}" method="POST"
    ...
    <div class="col-span-6 md:col-span-12">
        ...
        @if ($isEdit && $data->hasMedia('feature_image'))
            <div class="mt-2">
                <img src="{{ $data->getFirstMediaUrl('feature_image') }}" alt="data Image"

              ...
              <div class="col-xl-8 col-lg-8">
                  <div class="part-txt mb-70">
                      <div class="section-heading mb-70">
                          <h2 class="section-title mt--8 mb-25">Welcome to Our Study Advice Nepal</h2>
                          <p class="heading-sub-txt mt--1 mb--8">Here is what you can expect from a house cleaning from a
                              Handy professional.<br> Download the app to share further cleaning!</p>
                      </div>
                      <div class="row r-gap-40 has-gradient-service mb-30 mb-lg-0">
                          <div class="col-xl-6 col-md-6">
                              <div class="feature-box d-flex">
                                  ...
                                  <div class="feature-txt">
                                      <h3 class="feature-sub-title mt--7 mb--8"><a href="class-details.html">Active
                                              Learning</a></h3>
                                      <div class="divider mt-10 mb-20 bg-gradient-1 rounded-pill"></div>
                                      <p class="mt--6 mb--8">Since have been visonary relable sofware engnern partne.
                                      </p>
                                  </div>
                              </div>
                          </div>
                          ...
                          <div class="col-xl-6 col-md-6">
                              <div class="feature-box d-flex">
                                  ...
                                  <div class="feature-txt">
                                      <h3 class="feature-sub-title mt--7 mb--8"><a href="class-details.html">Expert
                                              Teachers</a></h3>
                          ...
                          <div class="col-xl-6 col-md-6">
                              <div class="feature-box d-flex">
                                  ...
                                  <div class="feature-txt">
                                      <h3 class="feature-sub-title mt--7 mb--8"><a href="class-details.html">Music
                                              Lessons</a></h3>
